//./src/component/weatherComponent.js
    ...
    axios
      ...
      .then((response) => {
        ...
        if (weatherDescription.includes("맑음")) {
          descriptionElement.className = "clear";
        } else if (
          weatherDescription.includes("흐림") ||
          weatherDescription.includes("구름")
        ) {
          descriptionElement.className = "clouds";
        } else if (weatherDescription.includes("비")) {
          descriptionElement.className = "rain";
        } else if (weatherDescription.includes("눈")) {
          descriptionElement.className = "snow";
        } else if (
          weatherDescription.includes("천둥") ||
          weatherDescription.includes("폭풍")
        ) {
          descriptionElement.className = "thunderstorm";
        }
      })
      .catch((error) => {
